    ...
    return <>
        <div id="app-container" className="w-full flex items-center mb-4 mt-10">
            <details className="w-full flex items-center px-6 bg-white rounded-md border-2 border-blue3 border-solid">
                ...
                <Link to={`/comments/${application.id}`} className="font-bold text-yellow-400 border-solid border-yellow-400 border-2 rounded-md cursor-pointer bg-blue3 p-3 justify-center inline-flex items-center no-underline text-center hover:bg-yellow-400 hover:text-blue3 hover:border-blue3">
                    Chat
                </Link>
